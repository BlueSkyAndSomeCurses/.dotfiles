...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('cSpellExt_british-english.enable', () => enable(true)), vscode.commands.registerCommand('cSpellExt_british-english.disable', () => disable(true)), vscode.commands.registerCommand('cSpellExt_british-english.enableWorkspace', () => enable(false)), vscode.commands.registerCommand('cSpellExt_british-english.disableWorkspace', () => disable(false)));
    //
}
