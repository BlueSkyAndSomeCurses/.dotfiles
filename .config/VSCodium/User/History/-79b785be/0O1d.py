...
def sort_students(gradebook: dict, sort_by: str, activity: str = None) -> dict:
    ...
    activity type, or general academic success.
...
"Додаткові бали": {"Додаткові бали": 4}},\
...
"Додаткові бали": {"Додаткові бали": 10}}},\
"Фінальний іспит")
    [('Stone', 'Oleskandr', 'sasha.kaminb.pn@ucu.edu.ua', 'ba'),\
 ('Pupkin', 'Vitya', 'vitya.pn@ucu.edu.ua', 'cs')]
...
"завдання на програмування 2": 10,\
"завдання на програмування 3": 1.56},\
"додаткові бали": {"Додаткові бали": 9}}} ,"Курс")
    [('Pupkin', 'Vitya', 'vitya.pn@ucu.edu.ua', 'cs'),\
 ('Stone', 'Oleskandr', 'sasha.kaminb.pn@ucu.edu.ua', 'ba')]
    """
    ...
    if sort_by == "Курс":
        ...
        return sorted(
            gradebook_concise, key=lambda x: gradebook_concise[x], reverse=True
        )

    if activity:
        return sorted(
            gradebook, key=lambda x: gradebook[x][sort_by][activity], reverse=True
        )

    return sorted(
        gradebook, key=lambda x: sum(gradebook[x][sort_by].values()), reverse=True
    )
